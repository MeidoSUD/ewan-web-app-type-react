...
export const TRANSLATIONS: Record<'en' | 'ar', Translations> = {
  en: {
    ...
    hits: "hits",
    noData: "No data yet",
    rankings: "Endpoint Rankings",
    clientErrors: "Client Errors",
    serverErrors: "Server Errors",
    highestMemoryUsage: "Peak Memory",
    // Pagination
    previous: "Previous",
    next: "Next",
    page: "Page",
  ...
  ar: {
    ...
    fastestEndpoint: "أسرع Endpoint",
    slowestEndpoint: "أبطأ Endpoint",
    mostUsed: "الأكثر استخداماً",
    leastUsed: "الأقل استخداماً",
    platformUsage: "استخدام المنصات",
    authStats: "إحصائيات التوثيق",
    authenticated: "مسجل",
    guest: "زائر",
    topEndpoints: "أفضل النقاط",
    ms: "مللي",
    hits: "طلب",
    noData: "لا توجد بيانات بعد",
    rankings: "ترتيب النقاط",
    clientErrors: "أخطاء العميل",
    serverErrors: "أخطاء الخادم",
    highestMemoryUsage: "أقصى استهلاك للذاكرة",
    // Pagination
    previous: "السابق",
    next: "التالي",
    page: "الصفحة",
