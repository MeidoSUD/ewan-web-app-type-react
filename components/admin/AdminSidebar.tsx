...
import { LayoutDashboard, Users, Layers, DollarSign, CheckSquare, AlertCircle, LogOut, Globe, Calendar, BookOpen, Settings, Package, ShoppingBag, Percent, Cog, ChevronDown, ChevronRight, Video, Monitor, FileText, Terminal, BarChart3, Activity } from 'lucide-react';
    ...
    const menuGroups = [
        ...
        },
        {
            ...
            children: [
                ...
                { id: 'activityRecords', label: language === 'ar' ? 'سجلات النشاطات' : 'Activity Records', icon: Activity },
                { id: 'systemLogs', label: language === 'ar' ? 'سجلات النظام' : 'System Logs', icon: Terminal },
